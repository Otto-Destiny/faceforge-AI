...
The face recognition model logic references the original implementation (face_recognition.py and app.py), © 2024 WorldQuant University, used here for educational purposes under CC BY-NC-ND 4.0.
